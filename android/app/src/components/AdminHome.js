    ...
    const toppingsobj = [
        {
            index: '1',
            toppings: 'Pepperoni',
            image: require("../assets/appleheck.png"),
                    ...
                    <View
                        ...
                        <View style={{ flexDirection: 'row' }}>
                            <View
                                ...
                                <Image source={require('../assets/manimg.png')} />
                            </View>
                        ...
                        <Image source={require('../assets/adminlist.png')} />
                    </View>
                </View>
            </View>
            <View style={{ flex: 8 }}>
                <Text style={{ color: bluecolor, fontSize: 15, fontWeight: 'bold', marginLeft: 20, marginTop: 10, marginBottom: 10 }}> ALL PRODUCTS</Text>
                ...
                <FlatList
                    ...
                    renderItem={({ item }) => {
                        return (
                            <View style={{
                                backgroundColor: '#ffffff', marginLeft: 20, marginRight: 20, width: 320, flex: 1, flexDirection: 'row', justifyContent: 'space-around', padding: 5,
                                ...
                                <View style={{ width: 90, marginLeft: 10 }}>
                                    <Image style={{ width: 90, height: 60, marginTop: 10 }} source={require('../assets/appleheck.png')} />
                                </View>
                                <View style={{ width: 100, justifyContent: 'center', alignItems: 'center' }}>
                                    <Text style={{ fontSize: 20, fontWeight: 'bold', color: greencolor }}>{item.toppings}</Text>
